		...
		navigator.geolocation.getCurrentPosition(function(position) {
			...
			$.ajax({
				...
				success: function(data) {
					...
					document.getElementById("dayanddate").innerHTML = Date();
					...
					document.getElementById('temp').innerHTML = ctemp.toFixed(1) + "&#8451";
					$('#temp').click(function() {
						var ftemp = data.main.temp * 1.8 + 32;
						var tempType = $("#temptype").val();
						if (tempType == "C") {
							document.getElementById('temp').innerHTML = ftemp.toFixed(1) + "&#8457";
							$("#temptype").val("F");
						} else {
							document.getElementById('temp').innerHTML = ctemp.toFixed(1) + "&#8451";
							$("#temptype").val("C");
